...
(function ($) {
  $.fn.fyl = function (opts) {
    ...
    if (!$.isNumeric(conf.char) || conf.char < 1) {
      conf.char = 1;
    }
    ...
    pop.width(clone.width()); // Add the predefined values
    ...
    function sx(t) {
      return $.trim($($.parseHTML(t)).text());
    }
  };
})(jQuery);
//# sourceMappingURL=mybb-autocomplete.js.map
